...
import com.altomedia.altotap.ui.screens.LoginScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            RupiahTapperTheme {
                ...
                val authManager = remember { GoogleAuthManager(applicationContext) }
                var isSplashFinished by remember { mutableStateOf(false) }
                var isLoggedIn by remember { mutableStateOf(authManager.isSignedIn()) }

                // When login state becomes true, update the ViewModel with Google user profile
                ...
                AnimatedContent(
                    targetState = Pair(isSplashFinished, isLoggedIn),
